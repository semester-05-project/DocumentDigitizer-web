...
const CloudStorage = () => {
	...
	return (
		<div className="offcanvas offcanvas-start" tabIndex="-1" id="profile" aria-labelledby="profileLabel">
			<div className="offcanvas-body">
				<div className="profile container-fluid row p-0 m-0">
					<section className="document-section col-12 p-0 m-0 d-flex flex-column">
